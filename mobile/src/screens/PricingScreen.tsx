...
const styles = StyleSheet.create({
  ...
  previewCost: { marginTop: 3, fontSize: 23, lineHeight: 26, color: '#B38433', fontWeight: '800' },
  previewArrow: { marginTop: 1, fontSize: 16, lineHeight: 20, color: '#1E1A16', fontWeight: '800' },
