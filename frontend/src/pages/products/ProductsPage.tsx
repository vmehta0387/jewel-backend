...
const isAutoGeneratedDesignName = (designName: string, jewelryGroup: string, designNo: string): boolean => {
  const normalizedName = normalizeLookupKey(designName);
  if (!normalizedName) return true;
  return (
    normalizedName === normalizeLookupKey(designNo) ||
    normalizedName === normalizeLookupKey(`${jewelryGroup} ${designNo}`.trim())
  );
};
